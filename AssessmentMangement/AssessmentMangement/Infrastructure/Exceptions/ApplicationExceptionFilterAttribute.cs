...
namespace AssessmentMangement.Infrastructure.Exceptions
{
    public class ApplicationExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            var problemDetails = new UpwardsProblemDetails()
            {
        ...
        public static JsonResult BuildErrorResponse(UpwardsProblemDetails problemDetails)
        {
